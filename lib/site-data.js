export const moduleLibrary = [
  {
    ...
    ctaAction: "launch a citizen reporting pilot",
  },
  {
    id: "ai-triage",
    name: "AI Triage",
...
export const heroStats = [
  { value: "24/7", label: "live citizen reporting" },
  { value: "< 3 min", label: "triage target" },
  { value: "+28%", label: "route efficiency" },
  { value: "92%", label: "classification confidence" },
];

export const liveActivity = [
  { time: "08:12", title: "Glass spill reported", detail: "A hazardous report was flagged near the market and added to the urgent queue." },
  { time: "08:18", title: "AI classification complete", detail: "The upload was scored with 0.92 confidence and routed to a supervisor review." },
  { time: "08:24", title: "Route updated", detail: "Nearby jobs were grouped to cut backtracking and lower fuel burn." },
  { time: "08:39", title: "Cleanup closed", detail: "The citizen received a resolution update and reward points." },
];
...
export const dashboardPanels = [
  {
    title: "Live city map",
    copy: "Heat points and priority markers show where the city is under pressure right now.",
  },
  {
    title: "Route control",
...
export const testimonials = [
  {
    quote: "EcoRoute AI makes the city feel responsive. Citizens know the report was seen, and crews know what to do next.",
    author: "Asha Mehta",
    role: "Municipal Operations Lead",
  },
  {
    quote: "The route optimizer is the part that sells the story. It turns a messy city issue into measurable efficiency.",
    author: "Rohan Das",
    role: "Smart City Program Manager",
  },
  {
    quote: "The dashboard looks like a real control room, which is exactly what judges want from a demo.",
    author: "Priya Kapoor",
...
export const suiteMetrics = [
  ...
  { value: "12m", label: "Response target", source: "pilot benchmark" },
...
export const pricingPlans = [
  {
    name: "Pilot",
    price: "Starter",
    blurb: "Best for a city demo or hackathon MVP.",
    features: ["Report intake", "Live map", "Basic dashboard"],
  },
  {
    name: "Scale",
    price: "Custom",
